...
public class Consulta_Ticket extends JDialog {
     ...
     * Create the dialog.
     */
    public Consulta_Ticket() {
        setTitle("TiendecitaJRM - Ticket - Consulta");
        ...
        btnConsulta.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                // Abrir el diálogo de consulta de ticket
                Panel_Consulta_Ticket panelConsultaTicket = new Panel_Consulta_Ticket();
                panelConsultaTicket.setVisible(true); // Mostrar el nuevo diálogo
            }
        });
